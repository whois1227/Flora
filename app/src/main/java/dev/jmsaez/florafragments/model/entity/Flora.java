...
public class Flora implements Parcelable {
    ...
    private String fitosociologia;
    private String biotipo;
    private String biologia_reproductiva;
    private String floracion;
    private String fructificacion;
    private String expresion_sexual;
    private String polinizacion;
    private String dispersion;
    private String numero_cromosomatico;
    private String reproduccion_asexual;
    private String distribucion;
    private String biologia;
    private String demografia;
    private String amenazas;
    private String medidas_propuestas;
    ...
    public Flora(long id, String nombre, String familia, String identificacion, String altitud,
                 String habitat, String fitosociologia, String biotipo, String biologia_reproductiva,
                 String floracion, String fructificacion, String expresion_sexual, String polinizacion,
                 String dispersion, String numero_cromosomatico, String reproduccion_asexual,
                 String distribucion, String biologia, String demografia, String amenazas,
                 String medidas_propuestas) {
